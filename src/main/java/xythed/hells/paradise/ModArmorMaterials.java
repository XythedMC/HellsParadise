...
public enum ModArmorMaterials implements ArmorMaterial {
    REAPERITE("reaperite", 43, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        map.put(ArmorItem.Type.BOOTS, 5);
        map.put(ArmorItem.Type.LEGGINGS, 8);
        map.put(ArmorItem.Type.CHESTPLATE, 10);
        map.put(ArmorItem.Type.HELMET, 5);
    }), 19, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0F, 0.2F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.REAPERITE_INGOT});
    });
